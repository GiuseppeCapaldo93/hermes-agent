...
AUTHOR_MAP = {
    "giuseppe.capaldo@t-systems.com": "GiuseppeCapaldo93",  # PR #1 (accept provider:model string entries from the desktop Fallback Models field)
    ...
    "giuseppe.capaldo@t-systems.com": "GiuseppeCapaldo93",  # PR #2 (model-metadata: back off and quiet blocked OpenRouter metadata fetch)
}
